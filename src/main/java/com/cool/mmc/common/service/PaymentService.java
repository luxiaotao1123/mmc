...
//
//    public Object executePayMoney(Long memberId, Long orderId, Double money, String clientIp, PayTypeEnum payType, PayCompanyEnum company, String openId, Boolean weChatV2) {
...
//        if (company.equals(PayCompanyEnum.weChat)){
