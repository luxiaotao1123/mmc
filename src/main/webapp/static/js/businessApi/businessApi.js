...
layui.use(['table','laydate', 'form'], function(){
    ...
    // 监听头工具栏事件
    table.on('toolbar(businessApi)', function (obj) {
        ...
        switch(obj.event) {
            ...
            case 'exportData':
                layer.confirm('确定导出Excel吗', function(){
                    ...
                    var param = {
                        'businessApi': exportData,
                        'fields': fields
                    };
                    $.ajax({
                        url: "/businessApi/export/auth",
                        headers: {'token': localStorage.getItem('token')},
    ...
    // 监听行工具事件
    table.on('tool(businessApi)', function(obj){
        var data = obj.data;
        switch (obj.event) {
            // 查看
            case 'detail':
