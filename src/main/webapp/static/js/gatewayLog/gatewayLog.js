...
layui.use(['table','laydate', 'form'], function(){
    ...
    tableIns = table.render({
        ...
        cols: [[
            ...
            ,{field: 'url', align: 'center',title: '访问地址'}
            ,{field: 'clientIp', align: 'center',title: '客户端地址'}
            ,{field: 'request', align: 'center',title: '请求内容'}
            ,{field: 'response', align: 'center',title: '相应内容'}
            ,{field: 'createTime$', align: 'center',title: '添加时间'}
            ,{field: 'status$', align: 'center',title: '数据状态'}
    ...
    // 监听头工具栏事件
    table.on('toolbar(gatewayLog)', function (obj) {
        ...
        switch(obj.event) {
            ...
            case 'exportData':
                layer.confirm('确定导出Excel吗', function(){
                    ...
                    var param = {
                        'gatewayLog': exportData,
                        'fields': fields
                    };
                    $.ajax({
                        url: "/gatewayLog/export/auth",
                        headers: {'token': localStorage.getItem('token')},
    ...
    // 监听行工具事件
    table.on('tool(gatewayLog)', function(obj){
        var data = obj.data;
        switch (obj.event) {
            // 查看
            case 'detail':
